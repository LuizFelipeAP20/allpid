<?php if(!class_exists('Rain\Tpl')){exit;}?>
        ...
        <section class="section section-lg text-center bg-default">
            <div class="container">
                ...
                <p class="wow-outer"><span class="text-width-1 wow slideInDown">A plataforma “ALLPID” surgiu na análise de reflexão na construção de apoiar usuários amadores, com acesso as tecnologias acessíveis, profissionais e artistas para criar um acervo dos seus conteúdos para indicar e divulgar aos curiosos e interessados, considerando a liberdade cultural, indicação de um conteúdo exclusivo a um cliente específico, produções criativas e desenhos artísticos, digitais ou a mão livre.
                </span></p>
                ...
                <div class="slick-widget-testimonials wow fadeIn">
                    ...
                    <div class="slick-slider carousel-parent" data-arrows="false" data-loop="true" data-dots="false" data-swipe="false" data-items="1" data-fade="true" data-child="#child-carousel" data-for="#child-carousel">
                        ...
                        <div class="item">
                            <!-- Quote Light 3-->
                            <blockquote class="quote-light">
                                <cite class="quote-light-cite">Marcio Júnior</cite>
                                <p class="quote-light-caption">Desenvolvedor</p>
                            </blockquote>
                        </div>
                    </div>
